...
class EmailSignUpUseCase extends ParamUseCase<Result<UserCredential, Exception>,
    Tuple2<String, String>> {
  final AuthRepository _repository;
  EmailSignUpUseCase(this._repository);
  ...
  Future<Result<UserCredential, Exception>> call(
    ...
    return _repository.signUpWithEmail(params.value1, params.value2);
  }
}
